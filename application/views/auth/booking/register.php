                    ...
                    <div class="col-md-7">
                        ...
                        <form action="<?php echo base_url(); ?>index.php/authenticate/register" method="post">
                            <div class="form-group first">
                                <input type="text" class="form-control" placeholder="Your Email" id="hideRole"
                                    name="hideRole" value="Customer" hidden>
                            </div>
                            <div class="form-group first">
                            ...
                            <div class="d-block mt-3 text-muted">Sudah punya akun? <a
                                    href="<?php echo base_url(); ?>index.php/authenticate/" class="choose-login">Log
                                    in</a></div>
                        </form>
                    </div>
                </div>
