...
<body>
    <div class="d-lg-flex half">
        <div class="bg order-1 order-md-2" style="background-image: url('<?php echo base_url(); ?>images/Image.jpg');">
        </div>
                        ...
                        <form action="<?php echo base_url(); ?>index.php/authenticate/logging_in" method="post">
                            ...
                            <div class="d-flex mb-5 align-items-center">
                                <span class="ml-auto"><a
                                        href="<?php echo base_url(); ?>index.php/authenticate/lupa_password"
                                        class="forgot-pass">Lupa Password?</a></span>
                            </div>
                            <input type="submit" value="Log In" class="btn btn-block btn-primary">
                            <div class="d-block mt-3 text-muted">Belum punya akun? <a
                                    href="<?php echo base_url(); ?>index.php/authenticate/register"
                                    class="choose-register">Register</a></div>
                            <div class="d-block mt-3 text-muted">Tertarik mengembangkan bisnis anda? <a
                                    href="<?php echo base_url(); ?>index.php/authenticate/partner_registration"
                                    class="choose-register">Jadi Partner WorkingHub</a></div>
                        </form>
                    </div>
                </div>
            </div>
