                                ...
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="checkbox" <?php if ($durasiJ != '') {
                                                              echo 'checked';
                                                            } ?> class="form-check-input" name="durasi[]" id="durasi" value="Jam">
                                    Jam
                                  </label>
                                </div>
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="checkbox" <?php if ($durasiH != '') {
                                                              echo 'checked';
                                                            } ?> class="form-check-input" name="durasi[]" id="durasi" value="Hari">
                                    Hari
                                  </label>
                                </div>
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="checkbox" <?php if ($durasiM != '') {
                                                              echo 'checked';
                                                            } ?> class="form-check-input" name="durasi[]" id="durasi" value="Minggu">
                                    Minggu
                                  </label>
                                </div>
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="checkbox" <?php if ($durasiB != '') {
                                                              echo 'checked';
                                                            } ?> class="form-check-input" name="durasi[]" id="durasi" value="Bulan">
                                    Bulan
                                  </label>
                                </div>
                              </div>
