                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary btn-icon" data-toggle="modal"
                                        data-target="#lihat<?= $p->id_pemesanan ?>"><i data-feather="eye"></i></button>
                                </td>
                            </tr>
                            <!-- Start Modal Edit -->
                            <div class="modal fade bd-example-modal-xl" id="lihat<?= $p->id_pemesanan ?>" tabindex="-1"
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <div class="detail-penyewaan">
                                                        <span>Nama Pemesan : <?= $p->name ?></span>
                                                        <br>
                                                        <span>Email : <?= $p->email ?></span>
                                                        <br>
                                                        <span>Nama Gedung : <?= $p->name ?></span>
                                                        <br>
                                                        <span>Nama Ruangan : <?= $p->name ?></span>
                                                        <br>
                                                        <span>Durasi :
                                                            <?= $p->jml_durasi . ' ' . $p->tipe_durasi ?></span>
                                                        <br>
                                                        ...
                                                        <span>Total Pembayaran :
                                                            <?= 'Rp ' . number_format($p->total_pembayaran, 0, ',', '.') ?></span>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="photo">
                                                        ...
                                                        ?>
                                                        <img src="data:image;base64,<?= $p->bukti_penerusan ?>"
