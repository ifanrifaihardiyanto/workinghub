    ...
    <div class="col-md-12 stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?php echo base_url(); ?>partner/manageruangan/addRuangan" method="post"
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nama Ruangan" name="nmRuangan"
                                    id="nmRuangan">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-multiple w-100" multiple="multiple" name="fasilitas[]"
                                    id="fasilitas">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Harga per jam" name="hargaJam"
                                    id="hargaJam">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Harga per hari" name="hargaHarian"
                                    id="hargaHarian">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Harga per minggu"
                                    name="hargaMingguan" id="hargaMingguan">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Harga per bulan"
                                    name="hargaBulanan" id="hargaBulanan">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input" name="durasi[]" id="durasi"
                                            value="Jam">
                                        Jam
                                    </label>
                                </div>
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                ...
                                <textarea id="deskripsi" name="deskripsi" class="form-control" maxlength="1000" rows="8"
                                    placeholder="This textarea has a limit of 1000 chars."></textarea>
