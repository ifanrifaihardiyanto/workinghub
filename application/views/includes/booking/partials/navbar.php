    ...
    <div class="navbar-content">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown nav-notifications">
                <a class="nav-link" href="<?php echo base_url(); ?>index.php/order" role="button">
            ...
            <li class="nav-item dropdown nav-notifications">
                <a role="button" href="<?php echo base_url(); ?>index.php/authenticate/register"
                ...
                <div class="dropdown-menu" aria-labelledby="profileDropdown">
                    ...
                    <div class="dropdown-body">
                        <ul class="profile-nav p-0 pt-3">
                            ...
                            <li class="nav-item">
                                <form action="<?php echo base_url(); ?>index.php/authenticate/logged_out" id="loggedOut"
                                    method="post"></form>
