                            ...
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-single w-100" name="lokasi" id="lokasi">
                                    ...
                                    <option value="<?= $lokasi->lokasi ?>"
                                        <?= $lokasi->lokasi == $lokasi->lokasi ? 'selected' : '' ?>>
...
<div class="pilihan-ruangan">
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-center">
                <div class="judul"><span class="text1">Working</span><span class="text2">Hub.</span> solusi bagi anda
                    untuk dapatkan ruangan terbaik</div>
            </div>
        </div>
        <div class="col-12">
            <div class="d-flex justify-content-center">
                <div class="keterangan">WorkingHub. adalah aplikasi penyewaan ruangan berbasis online di Indonesia yang
                    bisa menjadi pilihan terbaik Anda untuk menyewa ruangan di berbagai kota favorit.</div>
            </div>
        </div>
    </div>
</div>
