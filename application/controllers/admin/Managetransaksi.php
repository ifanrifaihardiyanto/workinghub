    ...
    public function valid($id_pemesanan, $kode_pemesanan)
    {
        ...
        if ($upload[0] != '') {
            if ($upload) {
                ...
                $this->manage_transaksi->valid(
                    $perihal,
                    $validasi,
                    $insertImage['bukti_forward'],
                    $insertFullPath['bukti_forward'],
                    $id_pemesanan,
                    $kode_pemesanan
                );
    ...
    public function invalid($id_pemesanan, $kode_pemesanan)
    {
        ...
        if ($upload[0] != '') {
            if ($upload) {
                ...
                $this->manage_transaksi->invalid(
                    $perihal,
                    $validasi,
                    $insertImage['bukti_pembalikkan'],
                    $insertFullPath['bukti_pembalikkan'],
                    $id_pemesanan,
                    $kode_pemesanan
                );
