...
class Payment_model extends CI_Model
{
    ...
    public function insertOrder($name, $no_tlp, $email, $name_gedung, $name_ruangan, $order_code, $order_date, $start_date, $end_date, $duration_type, $building_id, $duration_id, $room_id, $partner_id, $customer_id)
    {
        $sql = "insert into `order` (name, no_tlp, email, building_name, room_name, order_code, order_date, start_date, end_date, duration_type, building_id, duration_id, room_id, partner_id, customer_id, created_at, updated_at) 
        values 
        ('$name', '$no_tlp', '$email', '$name_gedung', '$name_ruangan', '$order_code', '$order_date', '$start_date', '$end_date', '$duration_type', '$building_id', '$duration_id', '$room_id', '$partner_id', '$customer_id', now(), now())";
